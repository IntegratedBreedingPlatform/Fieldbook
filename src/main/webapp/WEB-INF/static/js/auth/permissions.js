(function () {
	...
	module.constant('PERMISSIONS', {
		...
		FULL_MANAGE_STUDIES_PERMISSIONS: [
			...
			...INVENTORY, ...SAMPLE_LISTS, ...SSA_RESULTS, ...OBSERVATIONS,
		...
		DELETE_STUDY_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'DELETE_STUDY'],
		CLOSE_STUDY_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'CLOSE_STUDY'],
		LOCK_STUDY_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'LOCK_STUDY'],
