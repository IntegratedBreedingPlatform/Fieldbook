(function () {
	...
	const STUDY_SETTINGS_PERMISSIONS = [
		'MS_STUDY_SETTINGS',
		'MS_VIEW_STUDY_SETTINGS',
		'MS_ADD_STUDY_SETTINGS_VARIABLES'
	];

	const CROSSES_AND_SELECTIONS = [
	...
	const SAMPLE_GENOTYPES = [
		'MS_SAMPLE_GENOTYPES',
		'MS_VIEW_SAMPLE_GENOTYPES'
	];
	...
	module.constant('PERMISSIONS', {
		...
		FULL_MANAGE_STUDIES_PERMISSIONS: [
			...MANAGE_STUDIES_PERMISSIONS, ...GERMPLASM_AND_CHECKS_PERMISSIONS,
			...TREATMENT_FACTORS_PERMISSIONS, ...EXPERIMENTAL_DESIGN_PERMISSIONS,
			...ENVIRONMENT_PERMISSIONS, ...STUDY_SETTINGS_PERMISSIONS, ...CROSSES_AND_SELECTIONS,
			...INVENTORY, ...SAMPLE_LISTS, ...SAMPLE_GENOTYPES, ...SSA_RESULTS, ...OBSERVATIONS,
			'MS_STUDY_ACTIONS', 'CREATE_STUDIES', 'DELETE_STUDY', 'CLOSE_STUDY',
			'LOCK_STUDY', 'MS_CREATE_GENOTYPING_SAMPLES', 'MS_CREATE_GENOTYPING_SAMPLES',
			'MS_EXECUTE_CALCULATED_VARIABLES', 'MS_DESIGN_AND_PLANNING_OPTIONS', 'MS_EXPORT_DESIGN_TEMPLATE',
			'MS_CREATE_PLANTING_LABELS', 'MS_ADVANCES', 'MS_ADVANCE_STUDY', 'MS_ADVANCE_STUDY_FOR_PLANTS',
			'MS_ANALYZE_WITH_STA_BRAPP', 'MS_ANALYZE_WITH_DECISION_SUPPORT', 'MS_EXPORT_STUDY_BOOK',
			'MS_EXPORT_STUDY_ENTRIES', 'MS_MANAGE_OBSERVATION_UNITS', 'MS_WITHDRAW_INVENTORY', 'MS_CREATE_PENDING_WITHDRAWALS',
			'MS_CREATE_CONFIRMED_WITHDRAWALS', 'MS_CANCEL_PENDING_TRANSACTIONS', 'MS_CREATE_SUB_OBSERVATION_UNITS',
			'MS_CHANGE_PLOT_ENTRY', 'MS_CREATE_LOTS', 'MS_CROSSING_OPTIONS', 'MS_EXPORT_CROSSING_TEMPLATE',
			'MS_IMPORT_CROSSES', 'MS_DESIGN_NEW_CROSSES', 'MS_FIELD_MAP_OPTIONS', 'MS_MAKE_FIELD_MAP', 'MS_VIEW_FIELD_MAP',
			'MS_DELETE_FIELD_MAP', 'MS_CREATE_GEOREFERENCE', 'MS_EDIT_GEOREFERENCE'],
		...
		VIEW_SAMPLE_LISTS_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_SAMPLE_LISTS', 'MS_VIEW_SAMPLE_LISTS'],
		...
		VIEW_SAMPLE_GENOTYPES_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_SAMPLE_GENOTYPES', 'MS_VIEW_SAMPLE_GENOTYPES'],
		...
		EXPORT_STUDY_ENTRIES_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'MS_MANAGE_OBSERVATION_UNITS', 'MS_EXPORT_STUDY_ENTRIES'],

		MAKE_FIELD_MAP_PERMSISSION:[...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS','MS_FIELD_MAP_OPTIONS','MS_MAKE_FIELD_MAP'],
		VIEW_FIELD_MAP_PERMSISSION:[...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS','MS_FIELD_MAP_OPTIONS','MS_VIEW_FIELD_MAP'],
		DELETE_FIELD_MAP_PERMSISSION:[...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS','MS_FIELD_MAP_OPTIONS','MS_DELETE_FIELD_MAP'],
		CREATE_GEOREFERENCE_PERMSISSION:[...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS','MS_FIELD_MAP_OPTIONS','MS_CREATE_GEOREFERENCE'],
		EDIT_GEOREFERENCE_PERMSISSION:[...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS','MS_FIELD_MAP_OPTIONS','MS_EDIT_GEOREFERENCE'],

		EXPORT_CROSSING_TEMPLATE_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'MS_CROSSING_OPTIONS', 'MS_EXPORT_CROSSING_TEMPLATE'],
		IMPORT_CROSSES_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'MS_CROSSING_OPTIONS', 'MS_IMPORT_CROSSES'],
		DESIGN_NEW_CROSSES_PERMISSIONS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_STUDY_ACTIONS', 'MS_CROSSING_OPTIONS', 'MS_DESIGN_NEW_CROSSES'],

		VIEW_GERMPLASM_DETAILS: [...MANAGE_STUDIES_PERMISSIONS, 'MS_VIEW_GERMPLASM_DETAILS'],

		VIEW_PEDIGREE_INFORMATION_PERMISSIONS: ['ADMIN', 'GERMPLASM', 'VIEW_PEDIGREE_INFORMATION']
