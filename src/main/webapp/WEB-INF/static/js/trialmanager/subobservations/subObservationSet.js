		...
		function ($scope, $rootScope, TrialManagerDataService, $stateParams, DTOptionsBuilder, DTColumnBuilder, $http, $q, $compile,
			...
			function addCommonOptions(options) {
				return options
					...
					.withButtons([{
						...
						text: '<img src="/Fieldbook/static/img/statistics.svg" height="16px" width="16px" data-test="plotVisualizationButton"></img>',
			...
			function mapColumns(columnsData) {
				...
				angular.forEach(columnsData, function (columnData, index) {
					...
					} else if (columnData.termId === 8236 || columnData.termId === 8237) {
						// FEMALE_PARENT_NAME  or FEMALE_PARENT_GID
						columnsDef.push({
							targets: columns.length - 1,
							orderable: false,
							createdCell: function (td, cellData, rowData, rowIndex, colIndex) {
					...
					} else if (columnData.termId === 8238 || columnData.termId === 8239) {
